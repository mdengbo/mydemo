	  ...
	  <td style="height: 14px">
        ...
        <tr>
          <td style="height: 37px">
              ...
              <br />
              <asp:SqlDataSource ID="GoodStockWarningInfoDataSource" runat="server" ConnectionString="Data Source=.;Initial Catalog=SuperMarketInfo;uid=sa;pwd=sa"
                  SelectCommand="SELECT * FROM [goodStockInfoView] where goodCount > 200 or goodCount < 20" ProviderName="System.Data.SqlClient">
              </asp:SqlDataSource>
              &nbsp;
        </td>
      </tr>
