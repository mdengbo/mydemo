	  ...
	  <td style="height: 14px">
       ...
       <asp:Button ID="Btn_Query" runat="server" OnClick="Btn_Query_Click"
            Text="查询" /><br />
              ...
              <br />
              <asp:SqlDataSource ID="EmployeeInfoDataSource" runat="server" ConnectionString="Data Source=.;Initial Catalog=SuperMarketInfo;uid=sa;pwd=sa"
                  SelectCommand="SELECT * FROM [employeeInfoView]" ProviderName="System.Data.SqlClient">
              </asp:SqlDataSource>
        </td>
      </tr>
    </table>
