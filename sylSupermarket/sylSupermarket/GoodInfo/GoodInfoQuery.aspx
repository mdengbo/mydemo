<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoodInfoQuery.aspx.cs" Inherits="GoodInfo_GoodInfoQuery" %>
...
<body>
    <form method="post" id="frmAnnounce" runat="server">
	  ...
	  <td style="height: 14px">
          <img src="../images/list.gif" width=14px height=14px>商品信息管理--&gt;商品信息查询</td>
        </tr>
        <tr>
            ...
            Text="查询" /><br />
              <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                  ...
                  <Columns>
                      ...
                      <asp:HyperLinkField DataNavigateUrlFields="goodNo" DataNavigateUrlFormatString="GoodInfoDetails.aspx?goodNo={0}"
                          HeaderText="详细" Text="进入" />
                  </Columns>
              ...
              <br />
              <asp:SqlDataSource ID="GoodInfoDataSource" runat="server" ConnectionString="Data Source=.;Initial Catalog=SuperMarketInfo;uid=sa;pwd=sa"
                  SelectCommand="SELECT * FROM [goodInfoView]" ProviderName="System.Data.SqlClient">
              </asp:SqlDataSource>
              &nbsp;
        </td>
      </tr>
