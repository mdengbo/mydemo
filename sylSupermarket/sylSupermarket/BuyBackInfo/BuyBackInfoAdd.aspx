<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuyBackInfoAdd.aspx.cs" Inherits="BuyInfo_BuyBackInfoAdd" %>
...
<body>
   <form method="post" id="frmAnnounce" runat="server">
	  ...
	  <td style="height: 26px">
          ...
          <br />
          退货日期:
          <asp:TextBox ID="BuyBackDate" runat="server" Width="108px"></asp:TextBox><input class="submit" name="Button" onclick="seltime('BuyBackDate')" style="width: 30px"
                  type="button" value="选择" id="Button1" />
          <br />
          <br />
          退货原因:
          <asp:TextBox ID="BuyBackReason" runat="server" Height="55px" TextMode="MultiLine"
              Width="304px"></asp:TextBox><br />
          <br />
      </td>
	</tr>
          <tr>
              <td style="height: 24px">
                  <asp:Button
                      ID="Btn_Add" runat="server" OnClick="Btn_Add_Click" Text="退货登记" />&nbsp;<input type=button value="取消" onclick="javascript:location.href='BuyBackInfoAdd.aspx';" /></td>
          </tr>
         
      </table>
       &nbsp;&nbsp;&nbsp;
       <asp:SqlDataSource ID="SupplierDataSource" runat="server" ConnectionString="Data Source=.;Initial Catalog=SuperMarketInfo;uid=sa;pwd=sa"
