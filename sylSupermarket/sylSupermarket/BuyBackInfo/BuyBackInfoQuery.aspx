...
<body>
  ...
  <asp:SqlDataSource ID="BuyBackInfoDataSource" runat="server" ConnectionString="Data Source=.;Initial Catalog=SuperMarketInfo;uid=sa;pwd=sa"
                  SelectCommand="SELECT * from [buyBackInfoView]" ProviderName="System.Data.SqlClient">
              </asp:SqlDataSource>
</body>
</html>
