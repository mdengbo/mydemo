<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuyInfoQuery.aspx.cs" Inherits="BuyInfo_BuyInfoQuery" %>
...
<body>
       ...
       <asp:Button ID="Btn_Query" runat="server" OnClick="Btn_Query_Click"
            Text="查询" /><br />
              <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                  CellPadding="4" DataKeyNames="buyId" DataSourceID="BuyInfoDataSource"
                  ...
                  <Columns>
                      ...
                      <asp:BoundField DataField="number" HeaderText="进货数量" SortExpression="number" />
                      <asp:BoundField DataField="totalPrice" HeaderText="进货总价" SortExpression="totalPrice" />
                      <asp:BoundField DataField="buyDate" HeaderText="进货日期" SortExpression="buyDate" />
                  </Columns>
    ...
    <td align=right style="height: 12px">
        当前查询条件下进货总金额为：<asp:Label ID="TotalPrice" runat="server" Text="Label"></asp:Label>元</td></tr>
    </table>
  </form>
   <asp:SqlDataSource ID="BuyInfoDataSource" runat="server" ConnectionString="Data Source=.;Initial Catalog=SuperMarketInfo;uid=sa;pwd=sa"
                  SelectCommand="SELECT * from [buyInfoView]" ProviderName="System.Data.SqlClient">
              </asp:SqlDataSource>
</body>
</html>
